...
export function SubscriptionCreateDialog({
  ...
  const createMutation = useMutation(trpc.admin.users.subscription.create.mutationOptions({
    onSuccess: () => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button>Créer un abonnement</Button>
      </DialogTrigger>
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-lg">
        <DialogHeader>
          <DialogTitle>Créer un abonnement</DialogTitle>
          <DialogDescription>
            Créez un nouvel abonnement pour cet utilisateur.
          </DialogDescription>
        </DialogHeader>
