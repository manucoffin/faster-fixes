...
export function OrganizationIntegrationsTab() {
  ...
  const disconnectMutation = useMutation(
    trpc.authenticated.organization.github.disconnect.mutationOptions({
      onSuccess: () => {
        queryClient.invalidateQueries({
          queryKey:
            trpc.authenticated.organization.github.getInstallation.queryKey(),
        });
        ...
        {installation ? (
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      This will remove the connection and unlink all
                      repositories from your projects. Existing GitHub issues
                      will not be deleted.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
          ...
          <div className="flex flex-col gap-4">
            <p className="text-muted-foreground text-sm">
              No GitHub account connected. Install the Faster Fixes GitHub App
              to enable automatic issue creation from feedback.
            </p>
            <Button asChild>
              <a
