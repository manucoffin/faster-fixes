        ...
        <div className="mt-10 space-y-5 text-lg leading-relaxed">
          ...
          <ul className="list-disc space-y-3 pl-6 text-muted-foreground">
            ...
            <li>
              ...
              : built-in public roadmap and voting for product teams.
              FasterFixes does not support this.
            </li>
            <li>
          ...
          <p>
            ...
            NPS tracking, or non-technical client reporting, Usersnap is the
            more complete tool today. FasterFixes is built for a narrower brief,
            and we think it is the right brief for most developer teams shipping
            client websites:
          </p>
          <ul className="list-disc space-y-3 pl-6 text-muted-foreground">
            <li>
