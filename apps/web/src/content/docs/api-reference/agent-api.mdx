...
The Agent API is designed for programmatic access by AI coding agents. It's the same API used by the [MCP server](/docs/mcp).

**Base URL:** `https://app.faster-fixes.com/api/v1/agent`
...
Create agent tokens in **Organization Settings → Agent Tokens**. See [Agent Tokens](/docs/concepts/agent-tokens) for details.
